...
public interface TestRepository extends JpaRepository<Test, Integer> {
        ...
        Page<Test> findByTitleContainingIgnoreCaseAndTestLevelIdAndTestLevelLanguageId(String search,
                        Integer testLevelId,
                        Integer languageId, Pageable pageable);

        Page<Test> findByTestLevelIdAndTestLevelLanguageIdAndTypeId(Integer testLevelId, Integer languageId,
                        Integer typeId,
                        Pageable pageable);
